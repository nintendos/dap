...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'engine_project', 'project_leader_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'engine_project', 'project_leader',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='temp-pl', related_name='pm', to=orm['engine.Actor']),
                      keep_default=False)
